...
import { currentUser } from '@/lib/books';
...
export default function ProfilePage() {
  ...
  const stats = [
    ...
    { 
      title: 'Checked Out', 
      value: currentUser.booksCheckedOut, 
      icon: Clock, 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              <div className="w-14 h-14 bg-gradient-to-br from-blue-600 via-purple-600 to-cyan-600 rounded-2xl flex items-center justify-center shadow-2xl animate-pulse">
              ...
              <div>
                ...
                <p className="text-gray-600 font-medium">Your magical reading journey ⚡</p>
              </div>
            </div>
          ...
          <CardContent className="relative z-10 p-8">
            <div className="flex items-center space-x-8">
              ...
              <div className="flex-1">
                ...
                <p className="text-xl text-gray-600 mb-4">{currentUser.email}</p>
                <div className="flex items-center gap-4">
                  <Badge variant="secondary" className="bg-gradient-to-r from-blue-100 to-purple-100 text-blue-700 border-0 text-sm px-4 py-2">
                    ...
                    Scholar since {new Date(currentUser.joinDate).toLocaleDateString()}
                  </Badge>
                  <Badge className="bg-gradient-to-r from-yellow-400 to-orange-500 text-white border-0 animate-pulse text-sm px-4 py-2">
                    <Zap className="w-4 h-4 mr-2" />
                    Level 5 Master Reader
                  </Badge>
          ...
          <Card className="bg-gradient-to-br from-purple-50 to-pink-50 border-0 shadow-xl">
            ...
            <CardContent>
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-purple-700 mb-2">{currentUser.favoriteGenre}</h3>
