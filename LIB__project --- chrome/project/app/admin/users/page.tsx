                ...
                <TableBody>
                  {mockUsers.map((user) => (
                    <TableRow key={user.id} className="hover:bg-blue-50/50 transition-colors duration-200">
                      ...
                      <TableCell>
                        <Badge className={`${getRoleColor(user.role)} animate-pulse hover:animate-none transition-all duration-300`}>
                          {getRoleEmoji(user.role)} {user.role}
                        </Badge>
                      </TableCell>
                      <TableCell className="font-medium">{user.branch}</TableCell>
                      <TableCell>
                        <Badge className={`${getStatusColor(user.status)} animate-pulse hover:animate-none transition-all duration-300`}>
