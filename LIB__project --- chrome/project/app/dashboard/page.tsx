...
const RoleSelector = ({ currentRole, onRoleChange }) => (
  <div className="mb-8 p-6 bg-gradient-to-r from-blue-50 via-purple-50 to-pink-50 rounded-3xl border-2 border-blue-200/50 relative overflow-hidden">
      ...
      {['student', 'librarian', 'admin'].map((role) => (
        <Button
          ...
          className={`capitalize transition-all duration-300 hover:scale-110 ${
            currentRole === role 
              ? 'bg-gradient-to-r from-blue-500 via-purple-600 to-pink-600 shadow-lg' 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8 relative">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-2">
            Welcome back, {currentRole === 'student' ? 'Alex 🎓' : currentRole === 'librarian' ? 'Sarah 📚' : 'Admin 👑'}!
          </h1>
        ...
        {currentRole === 'librarian' && renderLibrarianDashboard()}
